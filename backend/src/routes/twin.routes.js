...
const { getTwinProfile, updateTwinProfile, enqueueAgentRun, getAgentRun, streamAgentEvents, downloadTwinFile } = require('../controllers/twinController');
...
router.get('/runs/:runId/events', optionalAuth, streamAgentEvents);
