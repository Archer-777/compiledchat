...
const SKY_KEYFRAMES: SkyKeyframe[] = [
  ...
  { hour: 6,    colors: ["#215985", "#7ba8c9", "#d68656"] },   // sunrise
  { hour: 8,    colors: ["#1b6ba4", "#9ec2df", "#d68656"] },   // morning cerulean sky
  { hour: 12,   colors: ["#1b6ba4", "#9ec2df", "#d68656"] },   // solar noon
  { hour: 15.5, colors: ["#1b6ba4", "#9ec2df", "#d68656"] },   // afternoon
  { hour: 17.5, colors: ["#244f77", "#7fa4c6", "#d68656"] },   // early dusk
  { hour: 19,   colors: ["#141026", "#2a1b42", "#784768"] },   // sunset / evening dusk
...
export function computeSolarState(fractionalHour: number, sunriseHour: number, sunsetHour: number): SolarState {
