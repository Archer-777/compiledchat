...
export default function AmbientBackground({ children, pureBlack = false }) {
  return (
    <div style={{ position: 'relative', width: '100%', minHeight: '100vh', backgroundColor: pureBlack ? '#000000' : '#050510', overflow: 'hidden' }}>
